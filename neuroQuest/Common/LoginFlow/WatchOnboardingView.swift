...
// MARK: - Particle Scene
class WatchParticleScene: SKScene {
...
struct OnboardingWatchView: View {
    ...
    let watchBlue = Color(red: 0.2, green: 0.5, blue: 1.0)
    let watchCyan = Color(red: 0.3, green: 0.8, blue: 0.9)
                ...
                VStack(spacing: 0) {
                    ...
                    ZStack {
                        ...
                        Image(systemName: "applewatch")
                            ...
                            .foregroundStyle(
                                LinearGradient(
                                    colors: [watchCyan, watchBlue],
                                    startPoint: .topLeading,
                                    endPoint: .bottomTrailing
                                )
                            )
                            .shadow(color: watchBlue.opacity(0.5), radius: 20)
                    ...
                    Text("To get real-time monitoring and feedback, please install the companion app on your Apple Watch.")
                        .font(.body)
                    ...
                    VStack(spacing: 14) {
                        Button(action: {
                            print("TODO: Add code to trigger Watch app install")
                            impactFeedback()
                        ...
                        .background(
                            Capsule()
                                .fill(watchBlue)
                                .shadow(color: watchBlue.opacity(0.4), radius: 15, y: 8)
                        )
...
//            }
    ...
    private func authenticateUser(role: UserRole) {
...
#Preview {
    OnboardingWatchView(authSheetState: .constant(.onboardingWatch))
